            ...
            <div className="space-y-6 bg-muted/50 p-6 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <Label>Pickup</Label>
                    <Input value={new Date(request.pickup_datetime).toLocaleString('en-US', { timeZone: 'Asia/Yangon', dateStyle: 'medium', timeStyle: 'short' })} disabled />
                  </div>
                  <div>
                    <Label>Return</Label>
                    <Input value={new Date(request.return_datetime).toLocaleString('en-US', { timeZone: 'Asia/Yangon', dateStyle: 'medium', timeStyle: 'short' })} disabled />
                  </div>
                  <div>
